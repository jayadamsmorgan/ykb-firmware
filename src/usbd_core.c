 ...
 */
hal_err usb_device_init(USBD_HandleTypeDef *pdev,
...
hal_err usb_device_register_class(USBD_HandleTypeDef *pdev,
...
hal_err usb_device_start(USBD_HandleTypeDef *pdev) {
